        ...
        <ul class="cart-items">
          <li v-for="(item, index) in cartItems" :key="index" class="cart-item">
            <div class="cart-item-content">
              {{item.price}}{{ item.size }} {{ item.name }}
              <ul>
            ...
            <span class="delete-item" @click="removeItemFromCart(index)">×</span>
          </li>
        </ul>
        
        <button @click="navigateToCheckOut" class="checkout-button shrink-border">
          Checkout
        </button>
      </div>
    </div>
