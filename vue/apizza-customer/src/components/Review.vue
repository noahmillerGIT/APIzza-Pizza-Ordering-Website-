<template>
  <div class="Review">
    ...
    <div class="review-box">
      ...
      <input v-model="name" type="text" id="reviewer-name" class="reviewer-name" />
      </div>
      ...
      <textarea v-model="comment" placeholder="Write your review here..." class="comment"></textarea>
    <button
    ref="submitButton"
    @click="submitReview"
    class="submit-review"
  ...
  methods: {
    ...
    submitReview() {
      if (this.rating === 5) {
        ...
        this.$root.$emit("review-submitted", {
